---
title: "DDR CONTROLLER DIF Checklist"
---

<!--
NOTE: This is a template checklist document that is required to be copied over
to `sw/device/lib/dif/dif_ddr_ctrl.md` for a new DIF that transitions
...
-->
This checklist is for [Development Stage]({{< relref "/doc/project/development_stages.md" >}}) transitions for the [DDR CONTROLLER DIF]({{< relref "hw/ip/ddr_ctrl/doc" >}}).
