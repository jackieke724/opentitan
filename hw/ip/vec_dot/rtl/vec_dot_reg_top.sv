...
module vec_dot_reg_top (
  ...
  always_comb begin
    ...
    addr_hit[4] = (reg_addr == VEC_DOT_MODE_OFFSET);
    addr_hit[5] = (reg_addr == VEC_DOT_STATUS_OFFSET);
    addr_hit[6] = (reg_addr == VEC_DOT_DOTP_RESULT_OFFSET);
    addr_hit[7] = (reg_addr == VEC_DOT_WDATA_OFFSET);
  end
  ...
  always_comb begin
    ...
    if (addr_hit[7] && reg_we && (VEC_DOT_PERMIT[7] != (VEC_DOT_PERMIT[7] & reg_be))) wr_err = 1'b1 ;
  end
  ...
  assign cmd_dummy_wd = reg_wdata[2];

  assign mode_we = addr_hit[4] & reg_we & ~wr_err;
  ...
  assign dotp_result_re = addr_hit[6] && reg_re;

  assign wdata_we = addr_hit[7] & reg_we & ~wr_err;
