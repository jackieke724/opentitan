...
module xbar_main (
  ...
  assign tl_sm1_29_us_h2d[1] = tl_s1n_30_ds_h2d[3];
  assign tl_s1n_30_ds_d2h[3] = tl_sm1_29_us_d2h[1];

  assign tl_sm1_32_us_h2d[0] = tl_s1n_30_ds_h2d[4];
  assign tl_s1n_30_ds_d2h[4] = tl_sm1_32_us_d2h[0];
  ...
  assign tl_keymgr_o = tl_s1n_30_ds_h2d[18];
  assign tl_s1n_30_ds_d2h[18] = tl_keymgr_i;

  assign tl_sm1_46_us_h2d[0] = tl_s1n_30_ds_h2d[19];
  assign tl_s1n_30_ds_d2h[19] = tl_sm1_46_us_d2h[0];

  assign tl_sm1_47_us_h2d[0] = tl_s1n_30_ds_h2d[20];
  assign tl_s1n_30_ds_d2h[20] = tl_sm1_47_us_d2h[0];

  assign tl_sm1_48_us_h2d[0] = tl_s1n_30_ds_h2d[21];
  assign tl_s1n_30_ds_d2h[21] = tl_sm1_48_us_d2h[0];

  assign tl_sm1_26_us_h2d[2] = tl_s1n_49_ds_h2d[0];
  assign tl_s1n_49_ds_d2h[0] = tl_sm1_26_us_d2h[2];

  assign tl_sm1_28_us_h2d[2] = tl_s1n_49_ds_h2d[1];
  assign tl_s1n_49_ds_d2h[1] = tl_sm1_28_us_d2h[2];

  assign tl_sm1_29_us_h2d[2] = tl_s1n_49_ds_h2d[2];
  assign tl_s1n_49_ds_d2h[2] = tl_sm1_29_us_d2h[2];

  assign tl_sm1_32_us_h2d[1] = tl_s1n_49_ds_h2d[3];
  assign tl_s1n_49_ds_d2h[3] = tl_sm1_32_us_d2h[1];
  ...
  assign tl_rom_o = tl_sm1_26_ds_h2d;
  assign tl_sm1_26_ds_d2h = tl_rom_i;
  ...
  assign tl_flash_ctrl_o = tl_sm1_33_ds_h2d;
  assign tl_sm1_33_ds_d2h = tl_flash_ctrl_i;
  ...
  assign tl_pinmux_o = tl_sm1_41_ds_h2d;
  assign tl_sm1_41_ds_d2h = tl_pinmux_i;

  assign tl_padctrl_o = tl_sm1_42_ds_h2d;
  assign tl_sm1_42_ds_d2h = tl_padctrl_i;

  assign tl_alert_handler_o = tl_sm1_43_ds_h2d;
  assign tl_sm1_43_ds_d2h = tl_alert_handler_i;

  assign tl_nmi_gen_o = tl_sm1_44_ds_h2d;
  assign tl_sm1_44_ds_d2h = tl_nmi_gen_i;

  assign tl_otbn_o = tl_sm1_45_ds_h2d;
  assign tl_sm1_45_ds_d2h = tl_otbn_i;

  assign tl_kmac_o = tl_sm1_46_ds_h2d;
  assign tl_sm1_46_ds_d2h = tl_kmac_i;

  assign tl_vec_dot_o = tl_sm1_47_ds_h2d;
  assign tl_sm1_47_ds_d2h = tl_vec_dot_i;

  assign tl_ddr_ctrl_o = tl_sm1_48_ds_h2d;
  assign tl_sm1_48_ds_d2h = tl_ddr_ctrl_i;
  ...
  always_comb begin
    ...
    end else if ((tl_s1n_30_us_h2d.a_address & ~(ADDR_MASK_DEBUG_MEM)) == ADDR_SPACE_DEBUG_MEM) begin
      dev_sel_s1n_30 = 5'd1;
    ...
    end else if ((tl_s1n_30_us_h2d.a_address & ~(ADDR_MASK_ENTROPY_SRC)) == ADDR_SPACE_ENTROPY_SRC) begin
      dev_sel_s1n_30 = 5'd7;

    end else if ((tl_s1n_30_us_h2d.a_address & ~(ADDR_MASK_CSRNG)) == ADDR_SPACE_CSRNG) begin
      dev_sel_s1n_30 = 5'd8;

    end else if ((tl_s1n_30_us_h2d.a_address & ~(ADDR_MASK_EDN0)) == ADDR_SPACE_EDN0) begin
      dev_sel_s1n_30 = 5'd9;

    end else if ((tl_s1n_30_us_h2d.a_address & ~(ADDR_MASK_EDN1)) == ADDR_SPACE_EDN1) begin
    ...
    end else if ((tl_s1n_30_us_h2d.a_address & ~(ADDR_MASK_PADCTRL)) == ADDR_SPACE_PADCTRL) begin
    ...
    end else if ((tl_s1n_30_us_h2d.a_address & ~(ADDR_MASK_OTBN)) == ADDR_SPACE_OTBN) begin
      dev_sel_s1n_30 = 5'd17;

    end else if ((tl_s1n_30_us_h2d.a_address & ~(ADDR_MASK_KEYMGR)) == ADDR_SPACE_KEYMGR) begin
      dev_sel_s1n_30 = 5'd18;

    end else if ((tl_s1n_30_us_h2d.a_address & ~(ADDR_MASK_KMAC)) == ADDR_SPACE_KMAC) begin
      dev_sel_s1n_30 = 5'd19;

    end else if ((tl_s1n_30_us_h2d.a_address & ~(ADDR_MASK_VEC_DOT)) == ADDR_SPACE_VEC_DOT) begin
      dev_sel_s1n_30 = 5'd20;

    end else if ((tl_s1n_30_us_h2d.a_address & ~(ADDR_MASK_DDR_CTRL)) == ADDR_SPACE_DDR_CTRL) begin
  ...
  always_comb begin
    ...
    if ((tl_s1n_49_us_h2d.a_address & ~(ADDR_MASK_ROM)) == ADDR_SPACE_ROM) begin
      dev_sel_s1n_49 = 5'd0;

    end else if ((tl_s1n_49_us_h2d.a_address & ~(ADDR_MASK_RAM_MAIN)) == ADDR_SPACE_RAM_MAIN) begin
      dev_sel_s1n_49 = 5'd1;

    end else if ((tl_s1n_49_us_h2d.a_address & ~(ADDR_MASK_EFLASH)) == ADDR_SPACE_EFLASH) begin
      dev_sel_s1n_49 = 5'd2;
      ...
      ((tl_s1n_49_us_h2d.a_address <= (ADDR_MASK_PERI[1] + ADDR_SPACE_PERI[1])) &&
       (tl_s1n_49_us_h2d.a_address >= ADDR_SPACE_PERI[1])) ||
      ((tl_s1n_49_us_h2d.a_address <= (ADDR_MASK_PERI[2] + ADDR_SPACE_PERI[2])) &&
       (tl_s1n_49_us_h2d.a_address >= ADDR_SPACE_PERI[2])) ||
      ((tl_s1n_49_us_h2d.a_address <= (ADDR_MASK_PERI[3] + ADDR_SPACE_PERI[3])) &&
       (tl_s1n_49_us_h2d.a_address >= ADDR_SPACE_PERI[3]))
    ) begin
      dev_sel_s1n_49 = 5'd3;

    end else if ((tl_s1n_49_us_h2d.a_address & ~(ADDR_MASK_FLASH_CTRL)) == ADDR_SPACE_FLASH_CTRL) begin
      dev_sel_s1n_49 = 5'd4;

    end else if ((tl_s1n_49_us_h2d.a_address & ~(ADDR_MASK_AES)) == ADDR_SPACE_AES) begin
      dev_sel_s1n_49 = 5'd5;

    end else if ((tl_s1n_49_us_h2d.a_address & ~(ADDR_MASK_ENTROPY_SRC)) == ADDR_SPACE_ENTROPY_SRC) begin
      dev_sel_s1n_49 = 5'd6;

    end else if ((tl_s1n_49_us_h2d.a_address & ~(ADDR_MASK_CSRNG)) == ADDR_SPACE_CSRNG) begin
      dev_sel_s1n_49 = 5'd7;

    end else if ((tl_s1n_49_us_h2d.a_address & ~(ADDR_MASK_EDN0)) == ADDR_SPACE_EDN0) begin
      dev_sel_s1n_49 = 5'd8;

    end else if ((tl_s1n_49_us_h2d.a_address & ~(ADDR_MASK_EDN1)) == ADDR_SPACE_EDN1) begin
      dev_sel_s1n_49 = 5'd9;

    end else if ((tl_s1n_49_us_h2d.a_address & ~(ADDR_MASK_HMAC)) == ADDR_SPACE_HMAC) begin
      dev_sel_s1n_49 = 5'd10;

    end else if ((tl_s1n_49_us_h2d.a_address & ~(ADDR_MASK_RV_PLIC)) == ADDR_SPACE_RV_PLIC) begin
      dev_sel_s1n_49 = 5'd11;

    end else if ((tl_s1n_49_us_h2d.a_address & ~(ADDR_MASK_PINMUX)) == ADDR_SPACE_PINMUX) begin
      dev_sel_s1n_49 = 5'd12;

    end else if ((tl_s1n_49_us_h2d.a_address & ~(ADDR_MASK_PADCTRL)) == ADDR_SPACE_PADCTRL) begin
      dev_sel_s1n_49 = 5'd13;

    end else if ((tl_s1n_49_us_h2d.a_address & ~(ADDR_MASK_ALERT_HANDLER)) == ADDR_SPACE_ALERT_HANDLER) begin
      dev_sel_s1n_49 = 5'd14;

    end else if ((tl_s1n_49_us_h2d.a_address & ~(ADDR_MASK_NMI_GEN)) == ADDR_SPACE_NMI_GEN) begin
      dev_sel_s1n_49 = 5'd15;

    end else if ((tl_s1n_49_us_h2d.a_address & ~(ADDR_MASK_OTBN)) == ADDR_SPACE_OTBN) begin
      dev_sel_s1n_49 = 5'd16;

    end else if ((tl_s1n_49_us_h2d.a_address & ~(ADDR_MASK_KMAC)) == ADDR_SPACE_KMAC) begin
      dev_sel_s1n_49 = 5'd17;

    end else if ((tl_s1n_49_us_h2d.a_address & ~(ADDR_MASK_VEC_DOT)) == ADDR_SPACE_VEC_DOT) begin
      dev_sel_s1n_49 = 5'd18;

    end else if ((tl_s1n_49_us_h2d.a_address & ~(ADDR_MASK_DDR_CTRL)) == ADDR_SPACE_DDR_CTRL) begin
  ...
  tlul_socket_1n #(
    ...
    .DReqPass  (22'h3bffff),
    .DRspPass  (22'h3bffff),
    .DReqDepth (88'h2000000000000000000),
    .DRspDepth (88'h2000000000000000000),
    .N         (22)
  ) u_s1n_30 (
    .clk_i        (clk_main_i),
    .rst_ni       (rst_main_ni),
