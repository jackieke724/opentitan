...
module xbar_main (
  ...
  output tlul_pkg::tl_h2d_t tl_dla_o,
  input  tlul_pkg::tl_d2h_t tl_dla_i,
  ...
  assign tl_dla_o = tl_sm1_46_ds_h2d;
  assign tl_sm1_46_ds_d2h = tl_dla_i;
  ...
  always_comb begin
    ...
    end else if ((tl_s1n_29_us_h2d.a_address & ~(ADDR_MASK_DLA)) == ADDR_SPACE_DLA) begin
  ...
  always_comb begin
    ...
    end else if ((tl_s1n_47_us_h2d.a_address & ~(ADDR_MASK_DLA)) == ADDR_SPACE_DLA) begin
