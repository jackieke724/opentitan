...
module clkmgr_reg_top (
  ...
  logic clk_hints_clk_main_vec_dot_hint_qs;
  logic clk_hints_clk_main_vec_dot_hint_wd;
  logic clk_hints_clk_main_vec_dot_hint_we;
  logic clk_hints_clk_main_ddr_ctrl_hint_qs;
  logic clk_hints_clk_main_ddr_ctrl_hint_wd;
  logic clk_hints_clk_main_ddr_ctrl_hint_we;
  ...
  logic clk_hints_status_clk_main_vec_dot_val_qs;
  logic clk_hints_status_clk_main_ddr_ctrl_val_qs;
  ...
  //   F[clk_main_vec_dot_hint]: 0:0
  prim_subreg #(
    .DW      (1),
    .SWACCESS("RW"),
    .RESVAL  (1'h1)
  ) u_clk_hints_clk_main_vec_dot_hint (
    .clk_i   (clk_i    ),
    .rst_ni  (rst_ni  ),

    // from register interface
    .we     (clk_hints_clk_main_vec_dot_hint_we),
    .wd     (clk_hints_clk_main_vec_dot_hint_wd),
    ...
    // to internal hardware
    .qe     (),
    .q      (reg2hw.clk_hints.clk_main_vec_dot_hint.q ),

    // to register interface (read)
    .qs     (clk_hints_clk_main_vec_dot_hint_qs)
  );


  //   F[clk_main_ddr_ctrl_hint]: 1:1
  prim_subreg #(
    .DW      (1),
    .SWACCESS("RW"),
    .RESVAL  (1'h1)
  ) u_clk_hints_clk_main_ddr_ctrl_hint (
    .clk_i   (clk_i    ),
    .rst_ni  (rst_ni  ),

    // from register interface
    .we     (clk_hints_clk_main_ddr_ctrl_hint_we),
    .wd     (clk_hints_clk_main_ddr_ctrl_hint_wd),
    ...
    // to internal hardware
    .qe     (),
    .q      (reg2hw.clk_hints.clk_main_ddr_ctrl_hint.q ),

    // to register interface (read)
    .qs     (clk_hints_clk_main_ddr_ctrl_hint_qs)
  );


  //   F[clk_main_aes_hint]: 2:2
  prim_subreg #(
    .DW      (1),
    .SWACCESS("RW"),
    .RESVAL  (1'h1)
  ...
  //   F[clk_main_vec_dot_val]: 0:0
  prim_subreg #(
    .DW      (1),
    .SWACCESS("RO"),
    .RESVAL  (1'h1)
  ) u_clk_hints_status_clk_main_vec_dot_val (
    .clk_i   (clk_i    ),
    .rst_ni  (rst_ni  ),
    ...
    // from internal hardware
    .de     (hw2reg.clk_hints_status.clk_main_vec_dot_val.de),
    .d      (hw2reg.clk_hints_status.clk_main_vec_dot_val.d ),
    ...
    // to register interface (read)
    .qs     (clk_hints_status_clk_main_vec_dot_val_qs)
  );


  //   F[clk_main_ddr_ctrl_val]: 1:1
  prim_subreg #(
    .DW      (1),
    .SWACCESS("RO"),
    .RESVAL  (1'h1)
  ) u_clk_hints_status_clk_main_ddr_ctrl_val (
    .clk_i   (clk_i    ),
    .rst_ni  (rst_ni  ),
    ...
    // from internal hardware
    .de     (hw2reg.clk_hints_status.clk_main_ddr_ctrl_val.de),
    .d      (hw2reg.clk_hints_status.clk_main_ddr_ctrl_val.d ),
    ...
    // to register interface (read)
    .qs     (clk_hints_status_clk_main_ddr_ctrl_val_qs)
  );


  //   F[clk_main_aes_val]: 2:2
  prim_subreg #(
    .DW      (1),
    .SWACCESS("RO"),
    .RESVAL  (1'h1)
  ...
  assign clk_hints_clk_main_vec_dot_hint_we = addr_hit[1] & reg_we & ~wr_err;
  assign clk_hints_clk_main_vec_dot_hint_wd = reg_wdata[0];

  assign clk_hints_clk_main_ddr_ctrl_hint_we = addr_hit[1] & reg_we & ~wr_err;
  assign clk_hints_clk_main_ddr_ctrl_hint_wd = reg_wdata[1];

  assign clk_hints_clk_main_aes_hint_we = addr_hit[1] & reg_we & ~wr_err;
  assign clk_hints_clk_main_aes_hint_wd = reg_wdata[2];

  assign clk_hints_clk_main_hmac_hint_we = addr_hit[1] & reg_we & ~wr_err;
  assign clk_hints_clk_main_hmac_hint_wd = reg_wdata[3];

  assign clk_hints_clk_main_kmac_hint_we = addr_hit[1] & reg_we & ~wr_err;
  assign clk_hints_clk_main_kmac_hint_wd = reg_wdata[4];
  ...
  always_comb begin
    ...
    unique case (1'b1)
      ...
      addr_hit[1]: begin
        reg_rdata_next[0] = clk_hints_clk_main_vec_dot_hint_qs;
        reg_rdata_next[1] = clk_hints_clk_main_ddr_ctrl_hint_qs;
        reg_rdata_next[2] = clk_hints_clk_main_aes_hint_qs;
        reg_rdata_next[3] = clk_hints_clk_main_hmac_hint_qs;
        reg_rdata_next[4] = clk_hints_clk_main_kmac_hint_qs;
        reg_rdata_next[5] = clk_hints_clk_main_otbn_hint_qs;
      end

      addr_hit[2]: begin
        reg_rdata_next[0] = clk_hints_status_clk_main_vec_dot_val_qs;
        reg_rdata_next[1] = clk_hints_status_clk_main_ddr_ctrl_val_qs;
        reg_rdata_next[2] = clk_hints_status_clk_main_aes_val_qs;
        reg_rdata_next[3] = clk_hints_status_clk_main_hmac_val_qs;
        reg_rdata_next[4] = clk_hints_status_clk_main_kmac_val_qs;
