...
module clkmgr_reg_top (
  ...
  logic clk_hints_clk_main_dla_hint_qs;
  logic clk_hints_clk_main_dla_hint_wd;
  logic clk_hints_clk_main_dla_hint_we;
  ...
  logic clk_hints_status_clk_main_dla_val_qs;
  ...
  //   F[clk_main_dla_hint]: 4:4
  prim_subreg #(
    .DW      (1),
    .SWACCESS("RW"),
    .RESVAL  (1'h1)
  ) u_clk_hints_clk_main_dla_hint (
    .clk_i   (clk_i    ),
    .rst_ni  (rst_ni  ),

    // from register interface
    .we     (clk_hints_clk_main_dla_hint_we),
    .wd     (clk_hints_clk_main_dla_hint_wd),
    ...
    // to internal hardware
    .qe     (),
    .q      (reg2hw.clk_hints.clk_main_dla_hint.q ),

    // to register interface (read)
    .qs     (clk_hints_clk_main_dla_hint_qs)
  );
  ...
  //   F[clk_main_dla_val]: 4:4
  prim_subreg #(
    .DW      (1),
    .SWACCESS("RO"),
    .RESVAL  (1'h1)
  ) u_clk_hints_status_clk_main_dla_val (
    .clk_i   (clk_i    ),
    .rst_ni  (rst_ni  ),
    ...
    // from internal hardware
    .de     (hw2reg.clk_hints_status.clk_main_dla_val.de),
    .d      (hw2reg.clk_hints_status.clk_main_dla_val.d ),
    ...
    // to register interface (read)
    .qs     (clk_hints_status_clk_main_dla_val_qs)
  );
  ...
  assign clk_hints_clk_main_dla_hint_we = addr_hit[1] & reg_we & ~wr_err;
  assign clk_hints_clk_main_dla_hint_wd = reg_wdata[4];
  ...
  always_comb begin
    ...
    unique case (1'b1)
      ...
      addr_hit[1]: begin
        ...
        reg_rdata_next[4] = clk_hints_clk_main_dla_hint_qs;
      end
      ...
      addr_hit[2]: begin
        ...
        reg_rdata_next[4] = clk_hints_status_clk_main_dla_val_qs;
      end
